...
def render_maze_game(grid: np.ndarray, screen: pygame.Surface, cell_size: int=20):
    ...
    agent_img = load_img('Program1\\assets\\agent.png', cell_size)
    brick_img = load_img('Program1\\assets\\brick.png', cell_size)
    goal_img = load_img('Program1\\assets\\end.png', cell_size)
    dirt_img = load_img('Program1\\assets\\dirt.png', cell_size)
    grass_img = load_img('Program1\\assets\\grass.png', cell_size)
    rock_img = load_img('Program1\\assets\\rock.png', cell_size)
    mud_img = load_img('Program1\\assets\\mud.png', cell_size)
